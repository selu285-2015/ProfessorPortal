/// <reference path="../pocketsphinx.js-master/pocketsphinx.js-master/webapp/js/recognizer.js" />
...
function updateHyp(hyp) {
    ...
    console.log(hyp);
    if (hyp == "Final: GO FUCK YOURSELF") window.open("http://amishrakefight.org");
    if (hyp == "Final: JUSTIN IS AWESOME") window.open("jusitnlejeune.com/resume");
    if (hyp == "Final: SUCK A DICK") window.open("http://google.com");
...
window.onload = function () {
    ...
    console.log("Here");
    spawnWorker("../pocketsphinx.js-master/pocketsphinx.js-master/webapp/js/recognizer.js", function (worker) {
...
//For Justin test
var grammarJustin = { numStates: 1, start: 0, end: 0, transitions: [{ from: 0, to: 0, word: "GO" }, { from: 0, to: 0, word: "FUCK" }, { from: 0, to: 0, word: "YOURSELF" }, { from: 0, to: 0, word: "JUSTIN" }, { from: 0, to: 0, word: "IS" }, { from: 0, to: 0, word: "AWESOME" }, { from: 0, to: 0, word: "SUCK" }, { from: 0, to: 0, word: "A" }, { from: 0, to: 0, word: "DICK" }] };
// Justin Phrases Test
var grammarJustinPhrase = { numStates: 4, start: 0, end: 3, transitions: [{ from: 0, to: 1, word: "GO" }, { from: 0, to: 1, word: "JUSTIN" }, { from: 0, to: 1, word: "SUCK" }, { from: 1, to: 2, word: "FUCK" }, { from: 1, to: 2, word: "IS" }, { from: 1, to: 2, word: "A" }, { from: 2, to: 3, word: "YOURSELF" }, { from: 2, to: 3, word: "AWESOME" }, { from: 2, to: 3, word: "DICK" }] };
...
var grammars = [{ title: "Justin Test", g: grammarJustin }, { title: "Justin Phrase Test", g: grammarJustinPhrase }];
var grammarIds = [];
